  ...
  return (
    <>
      <div className={clsx("flex flex-col  w-full  flex-start")}>
        ...
        <div className="relative flex gap-[18px] bg-[#ececec] rounded-[35px]  items-center justify-start h-[56px] pl-2.5">
            ...
            >
              <div className="flex gap-2 items-center justify-between">
                ...
                <div className="flex flex-col items-start">
                  <div className=" text-[10px] leading-0 ">Press here to </div>
                  <div className="text-[10px] -mt-1"> see replies</div>
                </div>
              </div>
            </div>
          </div>
