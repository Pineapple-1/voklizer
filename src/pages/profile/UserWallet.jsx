        ...
        {!isLoading && (
          <div className="flex flex-col gap-3 flex-1 h-full justify-between mb-4">
            <div className="flex flex-col gap-3 ">
              <div className="text-md font-bold">Statment</div>
              <div className="w-full h-0.5 bg-black"/>
              <div className="flex flex-col gap-4">
                {data.data.map((item) => (
                  <div className="flex flex-col gap-3" key={item.id}>
                    <div className="flex justify-between">
                      <div className="text-md">Voice Service Charged</div>
            ...
            <div className="flex flex-col gap-3 sticky bottom-0 bg-[#F5F5F5] pt-4 pb-4">
              ...
              <div className="flex justify-between">
                ...
                <div className="text-md font-bold">£{data.data.reduce((sum, item) => sum + item.amount, 0)}</div>
              </div>
            </div>
          </div>
        )}
