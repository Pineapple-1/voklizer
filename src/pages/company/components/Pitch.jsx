                    ...
                    <>
                        ...
                        >
                            <div className="flex gap-2 items-center w-full">
                                <div
                                    className="text-[#231F20] text-2xl bg-white rounded-3xl font-bold px-3 flex items-center gap-2">
                                    {isReplying ? (
                                        <>
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            >
                                ...
                                {((audioState.isPlaying &&
                                    ...
                                    <>
                                        <div
                                            className="absolute  animate-ping border border-white w-20 h-20 rounded-full " />
                                        <div
                        ...
                        <div className="w-full h-8 mt-4 mb-2 flex gap-1">
                            ...
                            <div className="w-3/5 shrink-0 -ml-3">
                                <GeometricButton
                                    type="button"
                                    variant={!isReplying ? "darkPrimary" : 'primary'}
                                    cut="left"
                                    width="100%"
                                    className="w-full h-8"
