    ...
    <div>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div
              className="bg-[#EEEEEE] shadow-lg  h-[130px]  w-[130px] rounded-lg flex flex-col items-center justify-between relative ">
              <div className="text-base opacity-0 ">Transmitting</div>
